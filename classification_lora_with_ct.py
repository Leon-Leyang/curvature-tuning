...
def replace_and_transfer_with_lora(beta, model_name, pretrained_ds, transfer_ds, rank, alpha, epochs, train_loader, val_loader):
    """
    Transfer learning.
    """
    ...
    if beta != 1:
        ...
        model = replace_module(model, nn.ReLU, CT, beta=beta)
...
def replace_then_lora_test_acc(beta_vals, pretrained_ds, transfer_ds, model_name='resnet18',  rank=1, alpha=1.0, epochs=30):
    ...
    transfer_model = replace_and_transfer_with_lora(1, model_name, pretrained_ds, transfer_ds, rank, alpha, epochs, train_loader, val_loader)
    ...
    if best_val_beta != 1:
        ...
        transfer_model = replace_and_transfer_with_lora(best_val_beta, model_name, pretrained_ds, transfer_ds, rank, alpha, epochs, train_loader, val_loader)
